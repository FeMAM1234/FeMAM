...
class server_meters():
    def __init__(self,args):
        ...
        self.eval_loss=[]
        self.overall_eval_loss=[]
        self.activate_eval_accuracy=[]
        self.overall_activate_eval_accuracy=[]
        self.activate_eval_loss=[]
        self.overall_activate_eval_loss=[]
    ...
    def update_structure_list(self,structure,epoch,act_client):
        if len(self.structure_list)==0 or len(structure)>len(self.structure_list[-1]):
            ...
            self.activate_list.append((epoch,act_client))
    # def update_vital_epoch(self,epoch,growing_layer,leaf_only):
    #     if not growing_layer:
    #         self.stop_growing_epoch=epoch
    #     if not leaf_only:
    #         self.stop_leaf_only_epoch=epoch
    def update(self,epoch,eval_accuracy,overall_eval_accuracy,eval_loss,overall_eval_loss,activate_eval_accuracy,overall_activate_eval_accuracy,activate_eval_loss,overall_activate_eval_loss):
        ...
        self.activate_eval_accuracy.append((epoch,activate_eval_accuracy))
        self.overall_activate_eval_accuracy.append((epoch,overall_activate_eval_accuracy))
        self.activate_eval_loss.append((epoch,activate_eval_loss))
        self.overall_activate_eval_loss.append((epoch,overall_activate_eval_loss))
...
class meters():
    ...
    def produce_metric(self):
        ...
        del self.predict
    # def print_information(self,structure):
    #     print('test_acc:',self.accuracy_score)
        # for group_id,group in structure.items():
        #     print(str(group_id),str(group.items()))
...
def save_meters(args,meter):
    dir='/home/shutoche/Data/dump_items_10/her3'
